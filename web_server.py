...
<br><br><iframe id="waitDisplay" src="/manual_waitForMac" style="border: none; width: 100%; height: 200px;"></iframe>
        ...
        if description == "watch" or forceManual == "1": #Manual entry
            ...
            instructionsLookup = {
                ...
                "MacBook": ["Open System Preferences", "Select Network", "In the left-hand pane, select 'Wifi'", "Click 'Advanced' in the lower right corner", "At the bottom of the windows, the your device's MAC address is listed as 'Wi-Fi address'"],
