...
<div class="alert">If you don't appear automatically, <a href="/manual_select/info" class="show">check your registered devices.</a></div>
...
if __name__ == "__main__":
    ...
    cherrypy.quickstart(main_server(), "/", {"/": {"log.access_file": config.data + "/logs/serverlog.log", "log.error_file": config.data + "/logs/serverlog.log", "tools.sessions.on": True, "tools.sessions.timeout": 30}, "/static": {
